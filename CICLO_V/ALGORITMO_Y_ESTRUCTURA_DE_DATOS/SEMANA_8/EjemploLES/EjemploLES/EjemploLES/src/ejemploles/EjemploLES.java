...
public class EjemploLES {
    ...
    public static void main(String[] args) {
        ...
        oLES.eliminaxInicio();System.out.println(oLES.muestraLES());
        oLES.eliminaxInicio();System.out.println(oLES.muestraLES());
        oLES.eliminaxFinal();System.out.println(oLES.muestraLES());
        oLES.eliminaxFinal();System.out.println(oLES.muestraLES());
        oLES.eliminaxFinal();System.out.println(oLES.muestraLES());
        oLES.eliminaNodoB(200);System.out.println(oLES.muestraLES());
        oLES.eliminaNodoB(70);System.out.println(oLES.muestraLES());
        oLES.eliminaNodoB(20);System.out.println(oLES.muestraLES());
        oLES.eliminaNodoB(20);System.out.println(oLES.muestraLES());
    }
}
